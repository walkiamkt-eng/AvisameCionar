...
export const INITIAL_POLIZAS: Poliza[] = [
  ...
  {
    id: 'pol-106',
    numeroPoliza: 'INC-449012',
    endoso: '000',
    clienteId: 'cli-1',
    aseguradoraId: 'aseg-1',
    ramo: 'Incendio',
    vigenciaDesde: '2025-11-01',
    vigenciaHasta: '2026-11-01',
    sumaAsegurada: 350000000,
    primaNeta: 210000,
    premioTotal: 310000,
    planCuotas: 10,
    estado: 'Vigente',
    bienAsegurado: 'Nave Industrial / Depósito de Logística en Avellaneda',
    riesgoCubierto: 'Incendio Edificio y Contenido + Remoción de Escombros + Caída de Aeronaves',
    objetoAsegurado: 'Nave Industrial Avellaneda',
    endosos: []
  },
  {
    id: 'pol-107',
    numeroPoliza: 'CONS-88201',
    endoso: '000',
    clienteId: 'cli-1',
    aseguradoraId: 'aseg-2',
    ramo: 'Integral de Consorcio',
    vigenciaDesde: '2025-07-15',
    vigenciaHasta: '2026-07-15',
    sumaAsegurada: 580000000,
    primaNeta: 195000,
    premioTotal: 285000,
    planCuotas: 12,
    estado: 'Vigente',
    bienAsegurado: 'Consorcio de Propietarios Edificio Belgrano 1240 (Ley 13.512)',
    riesgoCubierto: 'Incendio Edificio Total + RC Ascensores, Calderas, Mantenimiento y Garaje',
    objetoAsegurado: 'Edificio Consorcio Belgrano 1240',
    endosos: []
  },
  {
    id: 'pol-108',
    numeroPoliza: 'RC-309112',
    endoso: '000',
    clienteId: 'cli-4',
    aseguradoraId: 'aseg-5',
    ...
    sumaAsegurada: 120000000,
    primaNeta: 98000,
    premioTotal: 145000,
    planCuotas: 6,
    estado: 'Vigente',
    bienAsegurado: 'Empresa Agropecuaria El Ombú S.A. - Operaciones de Planta',
    riesgoCubierto: 'RC Comprensiva, Refacciones, Linderos y Escapes de Gas',
    objetoAsegurado: 'Planta Agropecuaria Tandil',
    endosos: []
  },
  {
    id: 'pol-109',
    numeroPoliza: 'CAUC-99102',
    endoso: '000',
    clienteId: 'cli-1',
    aseguradoraId: 'aseg-5',
    ...
    sumaAsegurada: 95000000,
    primaNeta: 140000,
    premioTotal: 190000,
    planCuotas: 1,
    estado: 'Vigente',
    bienAsegurado: 'Licitación Pública N° 12/2026 - Mantenimiento Vial',
    riesgoCubierto: 'Garantía de Mantenimiento de Oferta y Ejecución de Contrato',
    objetoAsegurado: 'Garantía Licitación Vial',
    endosos: []
  }
];
