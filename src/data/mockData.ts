...
export const INITIAL_ASEGURADORAS: Aseguradora[] = [
  {
    ...
    ramosHabilitados: ['Automotores', 'Combinado Familiar', 'Integral de Comercio', 'Integral de Consorcio', 'Incendio', 'Responsabilidad Civil', 'Accidentes Personales', 'Agro'],
  ...
  },
  {
    ...
    ramosHabilitados: ['Automotores', 'Combinado Familiar', 'Responsabilidad Civil', 'Incendio', 'Caución'],
    estadoSsn: 'Habilitada',
  ...
  },
  {
    ...
    ramosHabilitados: ['Automotores', 'Agro', 'Vida', 'Combinado Familiar', 'Seguro Técnico', 'Transporte de Mercaderías'],
    estadoSsn: 'Habilitada',
  ...
  },
  {
    ...
    ramosHabilitados: ['Automotores', 'Integral de Comercio', 'Integral de Consorcio', 'Caución', 'Vida', 'Responsabilidad Civil'],
    estadoSsn: 'Habilitada',
